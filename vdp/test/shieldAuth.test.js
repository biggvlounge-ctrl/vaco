// VDP — the browser Shield client, and the one branch in it that
// destroys something.
//
// **Why this file exists when the suite says client modules are not
// tested.** `vdp/test/commerce.test.js` states that the `*Client.js`
...
const KEY = 'vdp.shield.sessionToken';
