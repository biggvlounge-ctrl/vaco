# Plan — Phase 12: real persistence
...
VOKEN's own real business logic in `lib/*.js`.
...
a new top-level field (this store's own real fields today: cultureCards, cardPackTiers, raffles)
...
Created a real Cvltvre Card, confirmed the resulting real data landed in
...
## Done when
A restart of this app (port 8794) no longer loses any real state
