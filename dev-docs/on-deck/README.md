...
| `HVNTZ_CONNECTED_NETWORK_FREEZE.md` | frozen, **§40 audit complete 25 Sep 2026** — see below; §47 Phases 1-3 built (Network/Node/invite-accept-decline, Vault Studios stream link, Hunt checkpoint↔Network) in `hvntz/lib/networkConnections.js` and `hvntz/lib/hunts.js` | 23 Sep 2026 |
