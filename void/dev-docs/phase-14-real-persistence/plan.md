# Plan — Phase 14: real persistence
...
VOID's own real business logic in `lib/*.js`.
...
a new top-level field (this store's own real fields today: stations, noFlyZones, droneRoutes)
...
Registered a real drone station, confirmed the resulting real data landed in
...
## Done when
A restart of this app (port 8793) no longer loses any real state
