# Plan — Phase 13: real persistence
...
VACAY's own real business logic in `lib/*.js`.
...
a new top-level field (this store's own real fields today: listings, bookings, experiences)
...
Created a real stay listing, confirmed the resulting real data landed in
...
## Done when
A restart of this app (port 8803) no longer loses any real state
