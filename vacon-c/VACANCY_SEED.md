...
| Layer | State |
|---|---|
| Simulation engine | **73 modules, 1,604 KB** under `server/` |
...
| Tests | **1,188 in vacon-c** across 65 files, plus 172 in `world-layer/` |
| Measured completeness | **91.2%** — `dev-docs/GAME_COMPLETENESS.md`, regenerated by `scripts/completeness.mjs` |
