...
| Layer | State |
|---|---|
| Simulation engine | **75 modules, 1,852 KB** under `server/` |
| HTTP API | **79 routes registered** in `server.js` |
...
| Tests | **1,218 in vacon-c** across 68 files, plus 172 in `world-layer/` |
