...
*Current as of commit `9321643`, 103 commits, branch
...
| Automated tests | 1785 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1785/1785 across 39 suites (some skip without a database)
