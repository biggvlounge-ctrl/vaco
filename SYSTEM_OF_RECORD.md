...
*Current as of commit `04b6eec`, 94 commits, branch
...
| Automated tests | 1679 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1679/1679 across 39 suites (some skip without a database)
