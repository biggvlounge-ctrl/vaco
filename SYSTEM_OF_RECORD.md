...
| Automated tests | 2055 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 2055/2055 across 39 suites (some skip without a database)
...
| tables | 80.8% | schema tables a built world actually fills |
