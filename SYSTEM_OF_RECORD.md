...
*Current as of commit `9a7d645`, 101 commits, branch
...
| Automated tests | 1769 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1769/1769 across 39 suites (some skip without a database)
