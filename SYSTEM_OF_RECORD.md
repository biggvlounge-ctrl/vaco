...
*Current as of commit `bf03f21`, 125 commits, branch
`claude/v4-proxy-server-s6dcp8`, 13 Sep 2026.*
...
| Automated tests | 2035 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 2035/2035 across 39 suites (some skip without a database)
...
| tables | 76.2% | schema tables a built world actually fills |
