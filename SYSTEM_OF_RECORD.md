...
*Current as of commit `f576307`, 97 commits, branch
...
| Automated tests | 1728 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1728/1728 across 39 suites (some skip without a database)
