...
*Current as of commit `2d644e2`, 121 commits, branch
...
| Automated tests | 2022 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 2022/2022 across 39 suites (some skip without a database)
