...
*Current as of commit `dfa3f18`, 222 commits, branch
...
| Automated tests | 2762 across 40 suites |
...
```sh
node scripts/run-all-tests.mjs           # 2762/2762 across 40 suites (some skip without a database)
