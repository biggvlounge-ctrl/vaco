...
*Current as of commit `76039ba`, 120 commits, branch
...
| Automated tests | 1963 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1963/1963 across 39 suites (some skip without a database)
