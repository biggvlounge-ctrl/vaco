...
*Current as of commit `d253582`, 158 commits, branch
...
| Automated tests | 2291 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 2291/2291 across 39 suites (some skip without a database)
