...
*Current as of commit `cb00d9c`, 116 commits, branch
...
| Automated tests | 1913 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1913/1913 across 39 suites (some skip without a database)
