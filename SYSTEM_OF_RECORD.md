...
*Current as of commit `d48bd13`, 107 commits, branch
...
| Automated tests | 1836 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1836/1836 across 39 suites (some skip without a database)
