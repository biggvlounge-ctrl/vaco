...
*Current as of commit `1326d14`, 254 commits, branch
...
| Mutating HTTP routes | 547, all accounted for (494 guarded, 53 declared open with a reason) |
| Automated tests | 2844 across 41 suites |
...
```sh
node scripts/run-all-tests.mjs           # 2844/2844 across 41 suites (some skip without a database)
node scripts/audit-route-guards.mjs --check   # 547/547 accounted for
...
v4-search        15   hvntz            50   vaco-mcp         14
