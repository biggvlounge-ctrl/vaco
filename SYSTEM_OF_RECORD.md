...
*Current as of commit `9d8fa18`, 279 commits, branch
...
| Mutating HTTP routes | 554, all accounted for (501 guarded, 53 declared open with a reason) |
| Automated tests | 2890 across 41 suites |
...
```sh
node scripts/run-all-tests.mjs           # 2890/2890 across 41 suites (some skip without a database)
node scripts/audit-route-guards.mjs --check   # 554/554 accounted for
...
vavlt-stvdios    14   cvnvo            13   vago             73
