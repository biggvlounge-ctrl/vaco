...
*Current as of commit `f71eec9`, 258 commits, branch
...
| Automated tests | 2860 across 41 suites |
...
```sh
node scripts/run-all-tests.mjs           # 2860/2860 across 41 suites (some skip without a database)
...
v4-search        15   hvntz            66   vaco-mcp         14
