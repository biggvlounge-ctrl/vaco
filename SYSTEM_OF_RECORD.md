...
*Current as of commit `30bccdd`, 96 commits, branch
...
| Automated tests | 1713 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1713/1713 across 39 suites (some skip without a database)
