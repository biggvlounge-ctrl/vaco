...
*Current as of commit `7132d1d`, 114 commits, branch
...
| Automated tests | 1905 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1905/1905 across 39 suites (some skip without a database)
