...
*Current as of commit `1b717b7`, 73 commits, branch
...
| Automated tests | 1608 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1608/1608 across 39 suites (some skip without a database)
...
scripts         165   v3              109   vaco-media       51
