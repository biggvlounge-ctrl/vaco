...
*Current as of commit `bdf4a04`, 100 commits, branch
...
| Automated tests | 1767 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1767/1767 across 39 suites (some skip without a database)
