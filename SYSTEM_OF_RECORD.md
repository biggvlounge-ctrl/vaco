...
*Current as of commit `4d295cd`, 155 commits, branch
...
| Automated tests | 2276 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 2276/2276 across 39 suites (some skip without a database)
