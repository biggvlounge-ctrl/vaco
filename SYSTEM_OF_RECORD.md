...
| Automated tests | 2204 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 2204/2204 across 39 suites (some skip without a database)
