...
*Current as of commit `433ca9b`, 129 commits, branch
...
| Automated tests | 2096 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 2096/2096 across 39 suites (some skip without a database)
...
| tables | 88.5% | schema tables a built world actually fills |
