...
*Current as of commit `4ff8687`, 210 commits, branch
...
| Automated tests | 2717 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 2717/2717 across 39 suites (some skip without a database)
