...
*Current as of commit `5c332ce`, 102 commits, branch
...
| Automated tests | 1773 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1773/1773 across 39 suites (some skip without a database)
