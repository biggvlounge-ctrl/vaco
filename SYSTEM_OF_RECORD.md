...
*Current as of commit `800c2b1`, 98 commits, branch
...
| Automated tests | 1745 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1745/1745 across 39 suites (some skip without a database)
