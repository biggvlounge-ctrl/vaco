...
*Current as of commit `d6666de`, 113 commits, branch
...
| Automated tests | 1904 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1904/1904 across 39 suites (some skip without a database)
