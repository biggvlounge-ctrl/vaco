...
*Current as of commit `7fa42a5`, 119 commits, branch
...
| Automated tests | 1949 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1949/1949 across 39 suites (some skip without a database)
