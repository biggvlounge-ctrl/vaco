...
*Current as of commit `8c16fff`, 117 commits, branch
...
| Automated tests | 1932 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1932/1932 across 39 suites (some skip without a database)
