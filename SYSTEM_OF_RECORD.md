...
*Current as of commit `9a0bfbb`, 118 commits, branch
...
| Automated tests | 1948 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1948/1948 across 39 suites (some skip without a database)
