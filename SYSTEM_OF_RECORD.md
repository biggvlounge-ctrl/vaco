...
| Automated tests | 1641 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1641/1641 across 39 suites (some skip without a database)
...
vaco-shell       33   vacay            24   voidmagic        28
