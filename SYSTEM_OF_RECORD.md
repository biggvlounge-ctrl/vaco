...
*Current as of commit `f8bd5ce`, 92 commits, branch
...
| Automated tests | 1677 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1677/1677 across 39 suites (some skip without a database)
