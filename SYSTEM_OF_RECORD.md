...
*Current as of commit `0a4a6f1`, 262 commits, branch
...
| Automated tests | 2866 across 41 suites |
...
```sh
node scripts/run-all-tests.mjs           # 2866/2866 across 41 suites (some skip without a database)
...
v4-search        15   hvntz            72   vaco-mcp         14
