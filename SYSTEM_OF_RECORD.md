...
*Current as of commit `954fbaa`, 82 commits, branch
...
| Automated tests | 1633 across 39 suites |
| Persisted volumes | 30 |
| Shared-module copies kept in sync | 207 |
...
```sh
node scripts/run-all-tests.mjs           # 1633/1633 across 39 suites (some skip without a database)
node scripts/audit-route-guards.mjs --check   # 520/520 accounted for
./sync-shared-runtime.sh --check         # 207 copies current, none unmanaged
...
scripts         166   v3              109   vaco-media       51
