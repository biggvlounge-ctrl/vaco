...
*Current as of commit `f79f1e2`, 110 commits, branch
...
| Automated tests | 1888 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1888/1888 across 39 suites (some skip without a database)
