...
*Current as of commit `fa21011`, 78 commits, branch
...
| Automated tests | 1627 across 39 suites |
...
```sh
node scripts/run-all-tests.mjs           # 1627/1627 across 39 suites (some skip without a database)
